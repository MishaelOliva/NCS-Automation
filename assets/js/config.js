(function () {
    ...
    scope.elements = {
        ...
        excelCopyBtn: document.getElementById('excelCopyBtn'),
        excelCopyBtnText: document.getElementById('excelCopyBtnText'),
        ...
        excelFormulaBar: document.getElementById('excelFormulaBar'),
        excelActiveCellAddress: document.getElementById('excelActiveCellAddress'),
        excelFormulaValue: document.getElementById('excelFormulaValue'),
        excelSelectionCountBadge: document.getElementById('excelSelectionCountBadge'),
        excelToast: document.getElementById('excelToast'),
